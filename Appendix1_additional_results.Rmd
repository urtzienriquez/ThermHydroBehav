...
knitr::opts_knit$set(root.dir = '/media/urtzi/sugandila/ThermHydroBehav')
```
...
```{r, echo=F, fig.cap="Simulated microclimatic conditions at full sun along the year and at different depths. a) Average, b) minimum and c) maximum temperature, and d) water potential. Note that each value represents either the mean, minimum or maximum of the whole simulated period. Note also that water potential depends mostly on meteorological conditions rather than season.", fig.height=6}
...
```{r, echo=F, fig.cap="Simulated microclimatic conditions at deep (90%) shade along the year and at different depths. a) Average, b) minimum and c) maximum temperature, and d) water potential. Note that each value represents either the mean, minimum or maximum of the whole simulated period. Note also that water potential depends mostly on meteorological conditions rather than season.", fig.height=6}
