---
title: "X_microclimatic_validation"
...
## Validation of the microclimatic model
...
with(soil, plot(micro$dates, D0cm, type='l', xlim=as.POSIXct(c("2020-11-01 00:00:00 UTC","2021-04-30 23:00:00 UTC"))))
with(tsun1_0cm, points(datetime, temp, type='l', col='red'))
