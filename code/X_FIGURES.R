...
# ggexport(plot_depths, filename = "./results/FigSX_depth_sun.pdf", height = 2, width=11)
...
# save_plot("./results/FigSX_tb.pdf", plot_all, ncol = 2, nrow = 2, base_height = 4.5, base_aspect_ratio = 1)
...
smr_winter_cc <- data.frame(smr=c(smr_winter_b1w0_rcp45_CCSM4, `smr_winter_b1w0_rcp45_GFDL-CM3`, `smr_winter_b1w0_rcp45_HadGEM2-CC`,
                            ...
                            behavior=rep(rep(c('cold', 'cold-moist',
                                               'warm', 'warm-moist',
                                               'passive', 'passive-moist'), 
                                             times=c(length(c(smr_winter_b1w0_rcp45_CCSM4, `smr_winter_b1w0_rcp45_GFDL-CM3`, `smr_winter_b1w0_rcp45_HadGEM2-CC`,
                                                              smr_winter_b1w0_rcp85_CCSM4, `smr_winter_b1w0_rcp85_GFDL-CM3`, `smr_winter_b1w0_rcp85_HadGEM2-CC`)),
                                                     length(c(smr_winter_b1w1_rcp45_CCSM4, `smr_winter_b1w1_rcp45_GFDL-CM3`, `smr_winter_b1w1_rcp45_HadGEM2-CC`,
                                                              smr_winter_b1w1_rcp85_CCSM4, `smr_winter_b1w1_rcp85_GFDL-CM3`, `smr_winter_b1w1_rcp85_HadGEM2-CC`)),
                                                     length(c(smr_winter_b2w0_rcp45_CCSM4, `smr_winter_b2w0_rcp45_GFDL-CM3`, `smr_winter_b2w0_rcp45_HadGEM2-CC`,
                                                              smr_winter_b2w0_rcp85_CCSM4, `smr_winter_b2w0_rcp85_GFDL-CM3`, `smr_winter_b2w0_rcp85_HadGEM2-CC`)),
                                                     length(c(smr_winter_b2w1_rcp45_CCSM4, `smr_winter_b2w1_rcp45_GFDL-CM3`, `smr_winter_b2w1_rcp45_HadGEM2-CC`,
                                                              smr_winter_b2w1_rcp85_CCSM4, `smr_winter_b2w1_rcp85_GFDL-CM3`, `smr_winter_b2w1_rcp85_HadGEM2-CC`)),
                                                     length(c(smr_winter_b3w0_rcp45_CCSM4, `smr_winter_b3w0_rcp45_GFDL-CM3`, `smr_winter_b3w0_rcp45_HadGEM2-CC`,
                                                              smr_winter_b3w0_rcp85_CCSM4, `smr_winter_b3w0_rcp85_GFDL-CM3`, `smr_winter_b3w0_rcp85_HadGEM2-CC`)),
                                                     length(c(smr_winter_b3w1_rcp45_CCSM4, `smr_winter_b3w1_rcp45_GFDL-CM3`, `smr_winter_b3w1_rcp45_HadGEM2-CC`,
                                                              smr_winter_b3w1_rcp85_CCSM4, `smr_winter_b3w1_rcp85_GFDL-CM3`, `smr_winter_b3w1_rcp85_HadGEM2-CC`)))),times=2),
                            sce = rep(c('rcp45_CCSM4', 'rcp45_GFDL-CM3', 'rcp45_HadGEM2-CC',
                                        ...
                                        'rcp45_CCSM4', 'rcp45_GFDL-CM3', 'rcp45_HadGEM2-CC',
                                        'rcp85_CCSM4', 'rcp85_GFDL-CM3', 'rcp85_HadGEM2-CC'), 
                                      times=c(length(smr_winter_b1w0_rcp45_CCSM4), length(`smr_winter_b1w0_rcp45_GFDL-CM3`), length(`smr_winter_b1w0_rcp45_HadGEM2-CC`),
                                              length(smr_winter_b1w0_rcp85_CCSM4), length(`smr_winter_b1w0_rcp85_GFDL-CM3`), length(`smr_winter_b1w0_rcp85_HadGEM2-CC`),
                                              length(smr_winter_b1w1_rcp45_CCSM4), length(`smr_winter_b1w1_rcp45_GFDL-CM3`), length(`smr_winter_b1w1_rcp45_HadGEM2-CC`),
                                              length(smr_winter_b1w1_rcp85_CCSM4), length(`smr_winter_b1w1_rcp85_GFDL-CM3`), length(`smr_winter_b1w1_rcp85_HadGEM2-CC`),
                                              length(smr_winter_b2w0_rcp45_CCSM4), length(`smr_winter_b2w0_rcp45_GFDL-CM3`), length(`smr_winter_b2w0_rcp45_HadGEM2-CC`),
                                              length(smr_winter_b2w0_rcp85_CCSM4), length(`smr_winter_b2w0_rcp85_GFDL-CM3`), length(`smr_winter_b2w0_rcp85_HadGEM2-CC`),
                                              length(smr_winter_b2w1_rcp45_CCSM4), length(`smr_winter_b2w1_rcp45_GFDL-CM3`), length(`smr_winter_b2w1_rcp45_HadGEM2-CC`),
                                              length(smr_winter_b2w1_rcp85_CCSM4), length(`smr_winter_b2w1_rcp85_GFDL-CM3`), length(`smr_winter_b2w1_rcp85_HadGEM2-CC`),
                                              length(smr_winter_b3w0_rcp45_CCSM4), length(`smr_winter_b3w0_rcp45_GFDL-CM3`), length(`smr_winter_b3w0_rcp45_HadGEM2-CC`),
                                              length(smr_winter_b3w0_rcp85_CCSM4), length(`smr_winter_b3w0_rcp85_GFDL-CM3`), length(`smr_winter_b3w0_rcp85_HadGEM2-CC`),
                                              length(smr_winter_b3w1_rcp45_CCSM4), length(`smr_winter_b3w1_rcp45_GFDL-CM3`), length(`smr_winter_b3w1_rcp45_HadGEM2-CC`),
                                              length(smr_winter_b3w1_rcp85_CCSM4), length(`smr_winter_b3w1_rcp85_GFDL-CM3`), length(`smr_winter_b3w1_rcp85_HadGEM2-CC`))))
...
smr_summer_cc <- data.frame(smr=c(smr_summer_b1w0_rcp45_CCSM4, `smr_summer_b1w0_rcp45_GFDL-CM3`, `smr_summer_b1w0_rcp45_HadGEM2-CC`,
                            ...
                            acc=rep(c('no acc', 'acc'), times=c(602514, 602514)),
                            behavior=rep(rep(c('cold', 'cold-moist',
                                               'warm', 'warm-moist',
                                               'passive', 'passive-moist'), 
...
plot_smr_winter_cc <- ggplot(smr_winter_cc[smr_winter_cc$sce=='rcp85_HadGEM2-CC',], aes(y = interaction(acc, behavior),
                                                x = `smr`,
                                                fill = stat(x)))

plot_smr_summer_cc <- ggplot(smr_summer_cc[smr_summer_cc$sce=='rcp85_HadGEM2-CC',], aes(y = interaction(acc, behavior),
                                                x = `smr`,
                                                fill = stat(x)))

plot_smr_winter_cc_50cm <- ggplot(smr_winter_cc_50cm[smr_winter_cc_50cm$sce=='rcp85_HadGEM2-CC',], aes(y = interaction(acc, behavior),
                                                          x = `smr`,
                                                          fill = stat(x)))

plot_smr_summer_cc_50cm <- ggplot(smr_summer_cc_50cm[smr_summer_cc_50cm$sce=='rcp85_HadGEM2-CC',], aes(y = interaction(acc, behavior),
                                                          x = `smr`,
                                                          fill = stat(x)))
...
# save_plot("./results/Fig2_dSMR_vsColdNonAdapted_v2.pdf", plot_all_smr_cc, ncol = 2, nrow = 2, base_height = 4.5, base_aspect_ratio = 1)
...
# update: only depths (soil goes to SuppMat)

plot_depths <- ggarrange(p_depth_winter, p_dep_winter_cc, 
                         p_depth_summer, p_dep_summer_cc, 
                         p_depth_winter_50cm, p_dep_winter_cc_50cm, 
                         p_depth_summer_50cm, p_dep_summer_cc_50cm,
                         ncol = 2, nrow = 4, align='v',
                         labels=c('a', 'b', 'c', 'd', "e", "f", "g", "h"),
                         heights = c(2,2,2,2.5))


ggexport(plot_depths, filename = "./results/Fig1_depths_v3.pdf", height=10, width=6)
...
# save_plot("./results/Fig2_smr_present.pdf", plot_all_smr, ncol = 2, nrow = 2, base_height = 4.5, base_aspect_ratio = 1)
...
# save_plot("./results/Fig3_dSMR_vsColdNonAdapted.pdf", plot_all_smr_cc, ncol = 2, nrow = 2, base_height = 4.5, base_aspect_ratio = 1)
...
for(i in 1:length(environs_cc)){
  ...
  # TB
  # winter; 335 = 1 Dec; 59 = 28 February
  TC <- environ$TC[environ$DOY >= 335 | environ$DOY <= 59 & environ$ACT == 0]
  
  assign(paste('Tb_winter_', names(environs_cc)[i], sep=''), TC)
  
  # summer; 152 = 1 June; 243 = 31 August
  TC <- environ$TC[environ$DOY >= 152 & environ$DOY <= 243 & environ$ACT == 0]
  
  assign(paste('Tb_summer_', names(environs_cc)[i], sep=''), TC)
  ...
  assign(paste('Tb_winter_', names(environs_cc_50cm)[i], sep=''), TC)
  
  # summer; 152 = 1 June; 243 = 31 August
  TC <- environ$TC[environ$DOY >= 152 & environ$DOY <= 243 & environ$ACT == 0]
  
  assign(paste('Tb_summer_', names(environs_cc_50cm)[i], sep=''), TC)
}



Tb_winter_cc <- data.frame(Tb=c(Tb_winter_b1w0_rcp45_CCSM4, `Tb_winter_b1w0_rcp45_GFDL-CM3`, `Tb_winter_b1w0_rcp45_HadGEM2-CC`,
                                  Tb_winter_b1w0_rcp85_CCSM4, `Tb_winter_b1w0_rcp85_GFDL-CM3`, `Tb_winter_b1w0_rcp85_HadGEM2-CC`,
                                  Tb_winter_b1w1_rcp45_CCSM4, `Tb_winter_b1w1_rcp45_GFDL-CM3`, `Tb_winter_b1w1_rcp45_HadGEM2-CC`,
                                  Tb_winter_b1w1_rcp85_CCSM4, `Tb_winter_b1w1_rcp85_GFDL-CM3`, `Tb_winter_b1w1_rcp85_HadGEM2-CC`,
                                  Tb_winter_b2w0_rcp45_CCSM4, `Tb_winter_b2w0_rcp45_GFDL-CM3`, `Tb_winter_b2w0_rcp45_HadGEM2-CC`,
                                  Tb_winter_b2w0_rcp85_CCSM4, `Tb_winter_b2w0_rcp85_GFDL-CM3`, `Tb_winter_b2w0_rcp85_HadGEM2-CC`,
                                  Tb_winter_b2w1_rcp45_CCSM4, `Tb_winter_b2w1_rcp45_GFDL-CM3`, `Tb_winter_b2w1_rcp45_HadGEM2-CC`,
                                  Tb_winter_b2w1_rcp85_CCSM4, `Tb_winter_b2w1_rcp85_GFDL-CM3`, `Tb_winter_b2w1_rcp85_HadGEM2-CC`,
                                  Tb_winter_b3w0_rcp45_CCSM4, `Tb_winter_b3w0_rcp45_GFDL-CM3`, `Tb_winter_b3w0_rcp45_HadGEM2-CC`,
                                  Tb_winter_b3w0_rcp85_CCSM4, `Tb_winter_b3w0_rcp85_GFDL-CM3`, `Tb_winter_b3w0_rcp85_HadGEM2-CC`,
                                  Tb_winter_b3w1_rcp45_CCSM4, `Tb_winter_b3w1_rcp45_GFDL-CM3`, `Tb_winter_b3w1_rcp45_HadGEM2-CC`,
                                  Tb_winter_b3w1_rcp85_CCSM4, `Tb_winter_b3w1_rcp85_GFDL-CM3`, `Tb_winter_b3w1_rcp85_HadGEM2-CC`),
                            behavior=rep(c('cold', 'cold-moist',
                                               'warm', 'warm-moist',
                                               'passive', 'passive-moist'), each=111395),
                            sce = rep(rep(c('rcp45_CCSM4', 'rcp45_GFDL-CM3', 'rcp45_HadGEM2-CC',
                                            'rcp85_CCSM4', 'rcp85_GFDL-CM3', 'rcp85_HadGEM2-CC'), 
                                          each=19286), times=12))
...
Tb_summer_cc <- data.frame(Tb=c(Tb_summer_b1w0_rcp45_CCSM4, `Tb_summer_b1w0_rcp45_GFDL-CM3`, `Tb_summer_b1w0_rcp45_HadGEM2-CC`,
                                  Tb_summer_b1w0_rcp85_CCSM4, `Tb_summer_b1w0_rcp85_GFDL-CM3`, `Tb_summer_b1w0_rcp85_HadGEM2-CC`,
                                  Tb_summer_b1w1_rcp45_CCSM4, `Tb_summer_b1w1_rcp45_GFDL-CM3`, `Tb_summer_b1w1_rcp45_HadGEM2-CC`,
                                  Tb_summer_b1w1_rcp85_CCSM4, `Tb_summer_b1w1_rcp85_GFDL-CM3`, `Tb_summer_b1w1_rcp85_HadGEM2-CC`,
                                  Tb_summer_b2w0_rcp45_CCSM4, `Tb_summer_b2w0_rcp45_GFDL-CM3`, `Tb_summer_b2w0_rcp45_HadGEM2-CC`,
                                  Tb_summer_b2w0_rcp85_CCSM4, `Tb_summer_b2w0_rcp85_GFDL-CM3`, `Tb_summer_b2w0_rcp85_HadGEM2-CC`,
                                  Tb_summer_b2w1_rcp45_CCSM4, `Tb_summer_b2w1_rcp45_GFDL-CM3`, `Tb_summer_b2w1_rcp45_HadGEM2-CC`,
                                  Tb_summer_b2w1_rcp85_CCSM4, `Tb_summer_b2w1_rcp85_GFDL-CM3`, `Tb_summer_b2w1_rcp85_HadGEM2-CC`,
                                  Tb_summer_b3w0_rcp45_CCSM4, `Tb_summer_b3w0_rcp45_GFDL-CM3`, `Tb_summer_b3w0_rcp45_HadGEM2-CC`,
                                  Tb_summer_b3w0_rcp85_CCSM4, `Tb_summer_b3w0_rcp85_GFDL-CM3`, `Tb_summer_b3w0_rcp85_HadGEM2-CC`,
                                  Tb_summer_b3w1_rcp45_CCSM4, `Tb_summer_b3w1_rcp45_GFDL-CM3`, `Tb_summer_b3w1_rcp45_HadGEM2-CC`,
                                  Tb_summer_b3w1_rcp85_CCSM4, `Tb_summer_b3w1_rcp85_GFDL-CM3`, `Tb_summer_b3w1_rcp85_HadGEM2-CC`,
                                  Tb_acc_summer_b1w0_rcp45_CCSM4, `Tb_acc_summer_b1w0_rcp45_GFDL-CM3`, `Tb_acc_summer_b1w0_rcp45_HadGEM2-CC`,
                                  Tb_acc_summer_b1w0_rcp85_CCSM4, `Tb_acc_summer_b1w0_rcp85_GFDL-CM3`, `Tb_acc_summer_b1w0_rcp85_HadGEM2-CC`,
                                  Tb_acc_summer_b1w1_rcp45_CCSM4, `Tb_acc_summer_b1w1_rcp45_GFDL-CM3`, `Tb_acc_summer_b1w1_rcp45_HadGEM2-CC`,
                                  Tb_acc_summer_b1w1_rcp85_CCSM4, `Tb_acc_summer_b1w1_rcp85_GFDL-CM3`, `Tb_acc_summer_b1w1_rcp85_HadGEM2-CC`,
                                  Tb_acc_summer_b2w0_rcp45_CCSM4, `Tb_acc_summer_b2w0_rcp45_GFDL-CM3`, `Tb_acc_summer_b2w0_rcp45_HadGEM2-CC`,
                                  Tb_acc_summer_b2w0_rcp85_CCSM4, `Tb_acc_summer_b2w0_rcp85_GFDL-CM3`, `Tb_acc_summer_b2w0_rcp85_HadGEM2-CC`,
                                  Tb_acc_summer_b2w1_rcp45_CCSM4, `Tb_acc_summer_b2w1_rcp45_GFDL-CM3`, `Tb_acc_summer_b2w1_rcp45_HadGEM2-CC`,
                                  Tb_acc_summer_b2w1_rcp85_CCSM4, `Tb_acc_summer_b2w1_rcp85_GFDL-CM3`, `Tb_acc_summer_b2w1_rcp85_HadGEM2-CC`,
                                  Tb_acc_summer_b3w0_rcp45_CCSM4, `Tb_acc_summer_b3w0_rcp45_GFDL-CM3`, `Tb_acc_summer_b3w0_rcp45_HadGEM2-CC`,
                                  Tb_acc_summer_b3w0_rcp85_CCSM4, `Tb_acc_summer_b3w0_rcp85_GFDL-CM3`, `Tb_acc_summer_b3w0_rcp85_HadGEM2-CC`,
                                  Tb_acc_summer_b3w1_rcp45_CCSM4, `Tb_acc_summer_b3w1_rcp45_GFDL-CM3`, `Tb_acc_summer_b3w1_rcp45_HadGEM2-CC`,
                                  Tb_acc_summer_b3w1_rcp85_CCSM4, `Tb_acc_summer_b3w1_rcp85_GFDL-CM3`, `Tb_acc_summer_b3w1_rcp85_HadGEM2-CC`),
                            acc=rep(c('no acc', 'acc'), each=602514),
                            behavior=rep(rep(c('cold', 'cold-moist',
                                               'warm', 'warm-moist',
                                               'passive', 'passive-moist'), each=100419), times=2),
...
Tb_winter_cc_50cm <- data.frame(Tb=c(Tb_winter_b1w0_rcp45_CCSM4_50cm, `Tb_winter_b1w0_rcp45_GFDL-CM3_50cm`, `Tb_winter_b1w0_rcp45_HadGEM2-CC_50cm`,
                                       Tb_winter_b1w0_rcp85_CCSM4_50cm, `Tb_winter_b1w0_rcp85_GFDL-CM3_50cm`, `Tb_winter_b1w0_rcp85_HadGEM2-CC_50cm`,
                                       Tb_winter_b1w1_rcp45_CCSM4_50cm, `Tb_winter_b1w1_rcp45_GFDL-CM3_50cm`, `Tb_winter_b1w1_rcp45_HadGEM2-CC_50cm`,
                                       Tb_winter_b1w1_rcp85_CCSM4_50cm, `Tb_winter_b1w1_rcp85_GFDL-CM3_50cm`, `Tb_winter_b1w1_rcp85_HadGEM2-CC_50cm`,
                                       Tb_winter_b2w0_rcp45_CCSM4_50cm, `Tb_winter_b2w0_rcp45_GFDL-CM3_50cm`, `Tb_winter_b2w0_rcp45_HadGEM2-CC_50cm`,
                                       Tb_winter_b2w0_rcp85_CCSM4_50cm, `Tb_winter_b2w0_rcp85_GFDL-CM3_50cm`, `Tb_winter_b2w0_rcp85_HadGEM2-CC_50cm`,
                                       Tb_winter_b2w1_rcp45_CCSM4_50cm, `Tb_winter_b2w1_rcp45_GFDL-CM3_50cm`, `Tb_winter_b2w1_rcp45_HadGEM2-CC_50cm`,
                                       Tb_winter_b2w1_rcp85_CCSM4_50cm, `Tb_winter_b2w1_rcp85_GFDL-CM3_50cm`, `Tb_winter_b2w1_rcp85_HadGEM2-CC_50cm`,
                                       Tb_winter_b3w0_rcp45_CCSM4_50cm, `Tb_winter_b3w0_rcp45_GFDL-CM3_50cm`, `Tb_winter_b3w0_rcp45_HadGEM2-CC_50cm`,
                                       Tb_winter_b3w0_rcp85_CCSM4_50cm, `Tb_winter_b3w0_rcp85_GFDL-CM3_50cm`, `Tb_winter_b3w0_rcp85_HadGEM2-CC_50cm`,
                                       Tb_winter_b3w1_rcp45_CCSM4_50cm, `Tb_winter_b3w1_rcp45_GFDL-CM3_50cm`, `Tb_winter_b3w1_rcp45_HadGEM2-CC_50cm`,
                                       Tb_winter_b3w1_rcp85_CCSM4_50cm, `Tb_winter_b3w1_rcp85_GFDL-CM3_50cm`, `Tb_winter_b3w1_rcp85_HadGEM2-CC_50cm`,
                                       Tb_acc_winter_b1w0_rcp45_CCSM4_50cm, `Tb_acc_winter_b1w0_rcp45_GFDL-CM3_50cm`, `Tb_acc_winter_b1w0_rcp45_HadGEM2-CC_50cm`,
                                       Tb_acc_winter_b1w0_rcp85_CCSM4_50cm, `Tb_acc_winter_b1w0_rcp85_GFDL-CM3_50cm`, `Tb_acc_winter_b1w0_rcp85_HadGEM2-CC_50cm`,
                                       Tb_acc_winter_b1w1_rcp45_CCSM4_50cm, `Tb_acc_winter_b1w1_rcp45_GFDL-CM3_50cm`, `Tb_acc_winter_b1w1_rcp45_HadGEM2-CC_50cm`,
                                       Tb_acc_winter_b1w1_rcp85_CCSM4_50cm, `Tb_acc_winter_b1w1_rcp85_GFDL-CM3_50cm`, `Tb_acc_winter_b1w1_rcp85_HadGEM2-CC_50cm`,
                                       Tb_acc_winter_b2w0_rcp45_CCSM4_50cm, `Tb_acc_winter_b2w0_rcp45_GFDL-CM3_50cm`, `Tb_acc_winter_b2w0_rcp45_HadGEM2-CC_50cm`,
                                       Tb_acc_winter_b2w0_rcp85_CCSM4_50cm, `Tb_acc_winter_b2w0_rcp85_GFDL-CM3_50cm`, `Tb_acc_winter_b2w0_rcp85_HadGEM2-CC_50cm`,
                                       Tb_acc_winter_b2w1_rcp45_CCSM4_50cm, `Tb_acc_winter_b2w1_rcp45_GFDL-CM3_50cm`, `Tb_acc_winter_b2w1_rcp45_HadGEM2-CC_50cm`,
                                       Tb_acc_winter_b2w1_rcp85_CCSM4_50cm, `Tb_acc_winter_b2w1_rcp85_GFDL-CM3_50cm`, `Tb_acc_winter_b2w1_rcp85_HadGEM2-CC_50cm`,
                                       Tb_acc_winter_b3w0_rcp45_CCSM4_50cm, `Tb_acc_winter_b3w0_rcp45_GFDL-CM3_50cm`, `Tb_acc_winter_b3w0_rcp45_HadGEM2-CC_50cm`,
                                       Tb_acc_winter_b3w0_rcp85_CCSM4_50cm, `Tb_acc_winter_b3w0_rcp85_GFDL-CM3_50cm`, `Tb_acc_winter_b3w0_rcp85_HadGEM2-CC_50cm`,
                                       Tb_acc_winter_b3w1_rcp45_CCSM4_50cm, `Tb_acc_winter_b3w1_rcp45_GFDL-CM3_50cm`, `Tb_acc_winter_b3w1_rcp45_HadGEM2-CC_50cm`,
                                       Tb_acc_winter_b3w1_rcp85_CCSM4_50cm, `Tb_acc_winter_b3w1_rcp85_GFDL-CM3_50cm`, `Tb_acc_winter_b3w1_rcp85_HadGEM2-CC_50cm`),
                                 acc=rep(c('no acc', 'acc'), each=697968),
                                 behavior=rep(rep(c('cold', 'cold-moist',
                                                    'warm', 'warm-moist',
                                                    'passive', 'passive-moist'), each=116328), times=2),
...
Tb_summer_cc_50cm <- data.frame(Tb=c(Tb_summer_b1w0_rcp45_CCSM4_50cm, `Tb_summer_b1w0_rcp45_GFDL-CM3_50cm`, `Tb_summer_b1w0_rcp45_HadGEM2-CC_50cm`,
                                       Tb_summer_b1w0_rcp85_CCSM4_50cm, `Tb_summer_b1w0_rcp85_GFDL-CM3_50cm`, `Tb_summer_b1w0_rcp85_HadGEM2-CC_50cm`,
                                       Tb_summer_b1w1_rcp45_CCSM4_50cm, `Tb_summer_b1w1_rcp45_GFDL-CM3_50cm`, `Tb_summer_b1w1_rcp45_HadGEM2-CC_50cm`,
                                       Tb_summer_b1w1_rcp85_CCSM4_50cm, `Tb_summer_b1w1_rcp85_GFDL-CM3_50cm`, `Tb_summer_b1w1_rcp85_HadGEM2-CC_50cm`,
                                       Tb_summer_b2w0_rcp45_CCSM4_50cm, `Tb_summer_b2w0_rcp45_GFDL-CM3_50cm`, `Tb_summer_b2w0_rcp45_HadGEM2-CC_50cm`,
                                       Tb_summer_b2w0_rcp85_CCSM4_50cm, `Tb_summer_b2w0_rcp85_GFDL-CM3_50cm`, `Tb_summer_b2w0_rcp85_HadGEM2-CC_50cm`,
                                       Tb_summer_b2w1_rcp45_CCSM4_50cm, `Tb_summer_b2w1_rcp45_GFDL-CM3_50cm`, `Tb_summer_b2w1_rcp45_HadGEM2-CC_50cm`,
                                       Tb_summer_b2w1_rcp85_CCSM4_50cm, `Tb_summer_b2w1_rcp85_GFDL-CM3_50cm`, `Tb_summer_b2w1_rcp85_HadGEM2-CC_50cm`,
                                       Tb_summer_b3w0_rcp45_CCSM4_50cm, `Tb_summer_b3w0_rcp45_GFDL-CM3_50cm`, `Tb_summer_b3w0_rcp45_HadGEM2-CC_50cm`,
                                       Tb_summer_b3w0_rcp85_CCSM4_50cm, `Tb_summer_b3w0_rcp85_GFDL-CM3_50cm`, `Tb_summer_b3w0_rcp85_HadGEM2-CC_50cm`,
                                       Tb_summer_b3w1_rcp45_CCSM4_50cm, `Tb_summer_b3w1_rcp45_GFDL-CM3_50cm`, `Tb_summer_b3w1_rcp45_HadGEM2-CC_50cm`,
                                       Tb_summer_b3w1_rcp85_CCSM4_50cm, `Tb_summer_b3w1_rcp85_GFDL-CM3_50cm`, `Tb_summer_b3w1_rcp85_HadGEM2-CC_50cm`,
                                       Tb_acc_summer_b1w0_rcp45_CCSM4_50cm, `Tb_acc_summer_b1w0_rcp45_GFDL-CM3_50cm`, `Tb_acc_summer_b1w0_rcp45_HadGEM2-CC_50cm`,
                                       Tb_acc_summer_b1w0_rcp85_CCSM4_50cm, `Tb_acc_summer_b1w0_rcp85_GFDL-CM3_50cm`, `Tb_acc_summer_b1w0_rcp85_HadGEM2-CC_50cm`,
                                       Tb_acc_summer_b1w1_rcp45_CCSM4_50cm, `Tb_acc_summer_b1w1_rcp45_GFDL-CM3_50cm`, `Tb_acc_summer_b1w1_rcp45_HadGEM2-CC_50cm`,
                                       Tb_acc_summer_b1w1_rcp85_CCSM4_50cm, `Tb_acc_summer_b1w1_rcp85_GFDL-CM3_50cm`, `Tb_acc_summer_b1w1_rcp85_HadGEM2-CC_50cm`,
                                       Tb_acc_summer_b2w0_rcp45_CCSM4_50cm, `Tb_acc_summer_b2w0_rcp45_GFDL-CM3_50cm`, `Tb_acc_summer_b2w0_rcp45_HadGEM2-CC_50cm`,
                                       Tb_acc_summer_b2w0_rcp85_CCSM4_50cm, `Tb_acc_summer_b2w0_rcp85_GFDL-CM3_50cm`, `Tb_acc_summer_b2w0_rcp85_HadGEM2-CC_50cm`,
                                       Tb_acc_summer_b2w1_rcp45_CCSM4_50cm, `Tb_acc_summer_b2w1_rcp45_GFDL-CM3_50cm`, `Tb_acc_summer_b2w1_rcp45_HadGEM2-CC_50cm`,
                                       Tb_acc_summer_b2w1_rcp85_CCSM4_50cm, `Tb_acc_summer_b2w1_rcp85_GFDL-CM3_50cm`, `Tb_acc_summer_b2w1_rcp85_HadGEM2-CC_50cm`,
                                       Tb_acc_summer_b3w0_rcp45_CCSM4_50cm, `Tb_acc_summer_b3w0_rcp45_GFDL-CM3_50cm`, `Tb_acc_summer_b3w0_rcp45_HadGEM2-CC_50cm`,
                                       Tb_acc_summer_b3w0_rcp85_CCSM4_50cm, `Tb_acc_summer_b3w0_rcp85_GFDL-CM3_50cm`, `Tb_acc_summer_b3w0_rcp85_HadGEM2-CC_50cm`,
                                       Tb_acc_summer_b3w1_rcp45_CCSM4_50cm, `Tb_acc_summer_b3w1_rcp45_GFDL-CM3_50cm`, `Tb_acc_summer_b3w1_rcp45_HadGEM2-CC_50cm`,
                                       Tb_acc_summer_b3w1_rcp85_CCSM4_50cm, `Tb_acc_summer_b3w1_rcp85_GFDL-CM3_50cm`, `Tb_acc_summer_b3w1_rcp85_HadGEM2-CC_50cm`),
                                 acc=rep(c('no acc', 'acc'), each=602514),
                                 behavior=rep(rep(c('cold', 'cold-moist',
                                                    'warm', 'warm-moist',
                                                    'passive', 'passive-moist'), each=100419), times=2),
...
for(i in 1:length(environs)){
  ...
  with(environ, plot(TC ~ dates, ylab = "", xlab="month of year", col = 'black', xlim = c(0, 365*2), ylim = c(-70, 38), type = "l", yaxt = 'n'))
  with(environ, points(ACT * 2 - 10 ~ dates, type = "l", pch = 16, col = "orange"))
  with(environ, points(DEP/2 - 15 ~ dates, type = "l", col = "brown"))
  abline(4, 0, lty = 2, col = 'blue') # T_F_min
  abline(20, 0, lty = 2, col = 'red') # T_F_max
  abline(-2, 0, col = 'blue') # CT_min
  abline(36, 0, col = 'red') # CT_max
  ytick<-seq(0, 40, by=5)
  axis(side=2, at=ytick, labels = TRUE, las = 2)
  mtext(text = c('A', 'I'), side = 2, line = 1, at = c(-6, -10), cex = .7, las = 2)
  ytick<-seq(-6, -10, by=-4)
  axis(side=2, at=ytick, labels = FALSE)
  mtext(text = rev(seq(0, 100, 20)), side = 2, line = 1, at = seq(-65, -15, length.out=6), las = 2, cex = .7)
  ytick<-seq(-65, -15, length.out=6)
  axis(side=2, at=ytick, labels = FALSE)
  abline(h = -15, lty = 2, col = 'grey')
  mtext(text = c('body temperature (°C)', 'activity', 'depth (cm)'), side = 2, line = 2.5, at = c(22, -8, -40), cex = .7)
